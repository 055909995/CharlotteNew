...
class HTTPClient {
    ...
    func register(newUser: UserModel , complition: @escaping (_ response: AnyObject?, _ error: AnyObject?) -> Void) {
    ...
    func logIn(currentUser: UserModel ,complition: @escaping (_ response: AnyObject?, _ error: AnyObject?) -> Void){
        let email = currentUser.email
        let password = currentUser.password
        let url1 :String = baseURL + "s2s__login?uid=54f8da6118919cd09151c90f622a6337&email=" + email + "&password=" + password
        AF.request(URL(string: url1)!, method: .get, parameters: nil, encoding: JSONEncoding.default).responseJSON() { (response) in
            if response.result.value != nil {
                complition(response.result.value as AnyObject, nil)
            } else {
                complition(nil, response.result.error as AnyObject)
    ...
    func getInfo(id: String , complition: @escaping (_ response: AnyObject?, _ error: AnyObject?) -> Void){
        let url1 :String = baseURL + "s2s__get_user_info?uid=54f8da6118919cd09151c90f622a6337&user_id=" + id
        AF.request(URL(string: url1)!, method: .get, parameters: nil, encoding: JSONEncoding.default).responseJSON() { (response) in
            if response.result.value != nil {
                complition(response.result.value as AnyObject, nil)
            } else {
    ...
    func uploadImage(imgData: Data!) {
        ...
        let URL = try! URLRequest(url: "https://crm.s2s.host/video_api/s2s__upload_avatar?uid=54f8da6118919cd09151c90f622a6337&user_id=" + String(HTTPClient.shared.user.userID), method: .post)
    ...
    func searchOnlineUser(complition: @escaping (_ response: AnyObject?, _ error: AnyObject?) -> Void){
        let url1 :String = baseURL + "s2s__get_user?uid=54f8da6118919cd09151c90f622a6337"
        AF.request(URL(string: url1)!, method: .get, parameters: nil, encoding: JSONEncoding.default).responseJSON() { (response) in
            if response.result.value != nil {
                complition(response.result.value as AnyObject, nil)
            } else {
    ...
    func addToFriends(complition: @escaping (_ response: AnyObject?, _ error: AnyObject?) -> Void) {
    ...
    func getFriendList(complition: @escaping (_ response: AnyObject?, _ error: AnyObject?) -> Void) {
        let id = String(HTTPClient.shared.user.userID)
    ...
    func changeUsername(username: String ,password: String ,complition: @escaping (_ response: AnyObject?, _ error: AnyObject?) -> Void) {
        let id = String(HTTPClient.shared.user.userID)
    ...
    func changeEmail(email: String ,password: String ,complition: @escaping (_ response: AnyObject?, _ error: AnyObject?) -> Void) {
        let id = String(HTTPClient.shared.user.userID)
    ...
    func changePassword(newPassword: String , oldPassword: String ,complition: @escaping (_ response: AnyObject?, _ error: AnyObject?) -> Void) {
        let id = String(HTTPClient.shared.user.userID)
